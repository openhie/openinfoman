...
declare updating function csd_webui:redirect_out() as element(restxq:redirect) {
  csd_webui:redirect_out(())
};

declare updating function csd_webui:redirect_out($end ) as element(restxq:redirect)
{
